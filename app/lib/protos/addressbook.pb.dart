...
class Person_PhoneNumber extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Person.PhoneNumber', package: const $pb.PackageName(_omitMessageNames ? '' : 'tutorial'), createEmptyInstance: create)
    ...
    ..e<PhoneType>(2, _omitFieldNames ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: PhoneType.PHONE_TYPE_UNSPECIFIED, valueOf: PhoneType.valueOf, enumValues: PhoneType.values)
  ...
  @$pb.TagNumber(2)
  PhoneType get type => $_getN(1);
  @$pb.TagNumber(2)
  set type(PhoneType v) { setField(2, v); }
  @$pb.TagNumber(2)
